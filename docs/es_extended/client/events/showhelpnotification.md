...
此事件显示带有解析消息的帮助通知。这些帮助通知支持显示按钮输入，如下列表
...
![效果图](https://s2.ax1x.com/2020/02/27/30REqO.jpg)

###### 注意

请不要在客户端使用此事件，客户端请使用 [ESX.ShowHelpNotification](../functions/showhelpnotification.md)
